...
from .cog_sci_learning_model_base import (MultiArmedBanditModels, load_data, get_actions_rewards)

PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

class ContextualRascorlaWagnerChoiceKernelModel(MultiArmedBanditModels):
    """
    ...
    def crwck_exp(self, m=5):
        ...
        output_path = os.path.join(PROJECT_ROOT, 'data', 'data_frames', 'df_crwck.csv')
