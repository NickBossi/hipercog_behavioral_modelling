"""
Contextual Rescorla-Wagner with Choice Kernel Model (All Stimuli)
----------------------------------------------------------------
...
from .cog_sci_learning_model_base import (MultiArmedBanditModels, get_actions_rewards, load_matlab_data)

PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

class ContextualRascorlaWagnerChoiceKernelAllModel(MultiArmedBanditModels):
    """
    ...
    def crwck_all_exp(self, m=5):
        ...
        output_path = os.path.join(PROJECT_ROOT, 'data', 'data_frames', 'df_crwck_all.csv')
